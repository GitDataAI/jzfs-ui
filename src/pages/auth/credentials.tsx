    ...
    return (
        <>
            ...
            <div className="auth-learn-more">
                An access key-pair is the set of credentials used to access JiaoziFS. <a href="https://docs.lakefs.io/reference/authorization.html#authentication" target="_blank" rel="noopener noreferrer">Learn more.</a>
            </div>
