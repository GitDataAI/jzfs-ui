                    ...
                    <Card.Body className="after-setup-card">
                        ...
                        <div className="ms-2 mt-2">
                            <a target="_blank" rel="noreferrer" 
                               >jzctl</a> is a CLI tool for working with JZFS.
                            <p className="mt-2">
                            Download jzctl as part of the <a target="_blank" rel="noreferrer" href="">JZFS release package</a> and save the above credentials file as <code>~/.jzctl.yaml</code>.
                            </p>
                        </div>
                        <div className="mt-3 text-md-center">
