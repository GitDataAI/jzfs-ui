            ...
            <div className="clearfix">
                ...
                <div className="float-end">
                    ...
                    <ButtonGroup className="branch-actions ms-2">
                        ...
                        <ClipboardButton variant={buttonVariant} text={`jzfs://${repo.id}/${tag.id}`} tooltip="Copy URI to clipboard" icon={<LinkIcon />} />
    ...
    return (
        <>
            <div className="mb-5">
                ...
                {content}
                <div className={"mt-2"}>
                    A tag is an immutable pointer to a single commit. <a href="https://docs.pando.network" target="_blank" rel="noopener noreferrer">Learn more.</a>
                </div>
            </div>
        </>
    );
